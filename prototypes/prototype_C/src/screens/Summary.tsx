        ...
        <div className="start-debate-modal-overlay">
          <div className="start-debate-modal" style={{padding: 0, overflow: "hidden"}}>
            ...
            <div style={{padding: "0rem 1.5rem 1.5rem 1.5rem"}}>
              <p style={{fontSize: "18px", fontWeight: "600", marginBottom: "0.5rem"}}>{t("summaryPopupTitle")}</p>
              <p style={{fontSize: "16px", marginTop: "0"}}>{t("summaryPopupText")}</p>
              <button className="start-debate-btn" onClick={() => setShowIntroPopup(false)}>
                {t("continue")}
              </button>
            </div>
          </div>
